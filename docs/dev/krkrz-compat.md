...
PocketKrKr 直接继承并发展自 [reAAAq/KrKr2-Next](https://github.com/reAAAq/KrKr2-Next)。该项目提供了本仓库早期 KiriKiri2 运行环境的基础；PocketKrKr 在此基础上继续维护并扩展移动端平台、Flutter 集成、ANGLE 渲染、C ABI 桥接、资源格式、插件兼容和诊断工具。继承关系用于说明项目来源，不代表两个仓库当前代码、功能范围或验证结果完全一致。
